        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white pt-90">
                                <h5><b>LA MEJOR EN SONORA</b></h5>
                                <h2 class="mt-30 mb-15">Menú</h2>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
...
<section class="story-area left-text center-sm-text">
        <div class="container">
                <div class="heading"><h3>Escoge tu Pizza</h3></div>
                <div class="row">
...
<section class="story-area bg-seller color-white pos-relative">
        ...
        <div class="container">
                <h4 class="font-30 font-sm-20  center-text mb-25">Añade una fresca <b>Bebida</b> a tu orden</h4>
        </div><!-- container -->
</section>
...
<section>
        <div class="container">
                <div class="heading mb-sm-10"><h3>Escoge de las siguientes Bebidas</h3></div>
                <div class="row">
